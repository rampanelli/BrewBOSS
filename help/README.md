...
- ANY WARRANTY OF RELIABILITY;
- ANY WARRANTY OF COMPATIBILITY;
- ANY WARRANTY OF CONTINUOUS OR UNINTERRUPTED OPERATION;
- ANY WARRANTY THAT THE SOFTWARE IS ERROR-FREE, BUG-FREE, SAFE, OR SUITABLE FOR ANY PARTICULAR USE.

## 4. Safety and Operational Risk

The user acknowledges and agrees that:
- the software may contain defects, errors, omissions, vulnerabilities, or failures;
- the software may stop working at any time;
- the software may behave unpredictably;
...
IN NO EVENT SHALL THE COPYRIGHT HOLDER, AUTHORS, OR CONTRIBUTORS BE LIABLE FOR ANY CLAIM, LOSS, DAMAGE, COST, EXPENSE, OR LIABILITY OF ANY KIND, WHETHER DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR OTHERWISE, ARISING OUT OF OR IN CONNECTION WITH THE SOFTWARE OR THE USE OR OTHER DEALINGS IN THE SOFTWARE.
...
Any support, if ever provided, is entirely voluntary and does not create any continuing obligation.
